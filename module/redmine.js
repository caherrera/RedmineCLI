...
exports.connect = function (serverUrl, apiKey) {
    ...
    try {
        ...
        throw 'Connection to \'' + serverUrl + '\' failed.'
    }
    ;
...
exports.getProjectMemberships = function (identifier) {
    ...
    try {
        ...
        throw 'Could not load project memberships.'
    }
}
...
exports.createIssue = function (project, subject, options) {
    ...
    try {
        ...
        throw 'Could not create issue:\n' + err
    }
}


exports.logTime = function (id, hours, comments, options) {
    throwWhenNotConnected();

    try {
        var issueTime = {
            time_entry: {
                issue_id: id, hours: hours, activity_id: options.activity_id, comments: comments
            }
        };
        if (options.date) {
            issueTime.time_entry.spent_on = options.date;
        }
        if (options.activity_id) {
            issueTime.time_entry.activity_id = options.activity_id;
        }
        ...
        const logTime = JSON.parse(response.getBody('utf8'));
        return logTime;
        s
    } catch (err) {
        throw 'Could not create log time:\n' + err
    }
}
...
exports.getStatuses = function () {
    ...
    try {
        ...
        throw 'Could not load issue statuses.'
    }
}
...
exports.getPriorities = function () {
    ...
    try {
        ...
        throw 'Could not load issue priorities.'
    }
}
